...
//Read 2 integer numbers from the console than write into different 
//parameters their various mathematical interactions

import java.util.Scanner;

public class Problem2Variant1 {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		Scanner sc= new Scanner(System.in);
		int a, b; // declaring the 2 numbers, that will be used to make
					// different mathematical interactions
		// declaring the
		// variables
		// used for
		// different mathematical interractions
		int sum, sub1, sub2, mult, part1, part2, mod1, mod2;
